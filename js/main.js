const dict = {
  tr: {
    ...
    heroTag: "TÜBİTAK 3005", heroCategory: "Politika Araştırması",
    heroMetaInst: "Sakarya Üniversitesi", heroMetaDuration: "15 Ay", heroMediaCaption: "TR42 Doğu Marmara sanayi bölgesi",
    sidebarRegion: "Saha Bölgesi", searchPlaceholder: "Bulgu, il veya konu ara…",
    scaleTitle: "Araştırmanın Ölçeği",
    stat1: "Saha araştırmasına dahil edilen ihracatçı firma", stat2: "İl: Kocaeli, Sakarya, Düzce, Bolu, Yalova",
    stat3: "TÜBİTAK 3005 proje süresi", stat3unit: "ay", stat4: "Yayımlanmış analiz makalesi",
    processTitle: "Süreç",
    proc1Title: "Belirleyicilerin Keşfi", proc1Desc: "Literatür taraması ve uzman görüşü",
    proc2Title: "Saha Araştırması", proc2Desc: "Nicel veri ve nitel görüşmeler",
    proc3Title: "Analiz ve Bulgular", proc3Desc: "Belirleyicilerin önem sırasına konması",
    proc4Title: "Politika Önerisi Seti", proc4Desc: "Kamu kurumlarıyla paylaşım",
    statusDone: "Tamamlandı", statusOngoing: "Sürüyor", statusPending: "Planlanıyor",
    findingsTitle: "Yayımlanan Analizler", findingsMore: "Tümünü Gör",
    ...
    donutCenterLbl: "nihai belirleyici",
    dvName1: "Finansal Belirleyiciler", dvName2: "Rekabet, Fırsatlar ve Riskler", dvName3: "Stratejik Kararlar ve İnovasyon", dvName4: "Girişimci Özellikleri ve Network", dvName5: "Diğer 5 Belirleyici",
    stat2mini: "İl", stat3mini: "Süre", stat4mini: "Makale",
    pullQuote1: "\"Dış ticaret girişimciliğinin başarısında en birincil rolü %12,86'lık nihai grup ağırlığı ile Finansal Belirleyiciler üstlenmektedir.\"",
    pullQuoteCite: "Sahadan Bulgularla İhracatın Yapı Taşları araştırma notundan",
    reportCoverTitle: "İhracat Teşviklerinin Dış Ticaret Girişimciliği Perspektifiyle Revize Edilmesi",
    reportBadge: "Hazırlanıyor", reportTitle: "Proje Sonuç Raporu", reportDesc: "Tam metin rapor, saha araştırması tamamlandığında burada yayımlanacak.", reportBtn: "Yayınlar Sayfasına Git"
  },
  en: {
    ...
    heroTag: "TÜBİTAK 3005", heroCategory: "Policy Research",
    heroMetaInst: "Sakarya University", heroMetaDuration: "15 Months", heroMediaCaption: "TR42 East Marmara industrial region",
    sidebarRegion: "Field Region", searchPlaceholder: "Search findings, provinces, or topics…",
    scaleTitle: "Scale of the Research",
    stat1: "Exporting firms included in the field research", stat2: "Provinces: Kocaeli, Sakarya, Düzce, Bolu, Yalova",
    stat3: "TÜBİTAK 3005 project duration", stat3unit: "months", stat4: "Published analysis articles",
    processTitle: "Process",
    proc1Title: "Discovery of Determinants", proc1Desc: "Literature review and expert opinion",
    proc2Title: "Field Research", proc2Desc: "Quantitative data and qualitative interviews",
    proc3Title: "Analysis and Findings", proc3Desc: "Ranking determinants by importance",
    proc4Title: "Policy Recommendation Set", proc4Desc: "Sharing with public institutions",
    statusDone: "Completed", statusOngoing: "Ongoing", statusPending: "Planned",
    findingsTitle: "Published Analyses", findingsMore: "View All",
    ...
    donutCenterLbl: "final determinants",
    dvName1: "Financial Determinants", dvName2: "Competition, Opportunities, Risks", dvName3: "Strategic Decisions & Innovation", dvName4: "Entrepreneur Traits & Network", dvName5: "Other 5 Determinants",
    stat2mini: "Provinces", stat3mini: "Duration", stat4mini: "Articles",
    pullQuote1: "\"Financial Determinants play the primary role in the success of foreign trade entrepreneurship, with a final group weight of 12.86%.\"",
    pullQuoteCite: "From the research note: The Building Blocks of Export Success",
    reportCoverTitle: "Policy Recommendations for Revising Export Incentives from the Perspective of Foreign Trade Entrepreneurship",
    reportBadge: "In Preparation", reportTitle: "Final Project Report", reportDesc: "The full-text report will be published here once the field research is complete.", reportBtn: "Go to Publications"
  }
};
...
function renderDynamicData() {
  ...
  if (ekipEl) {
    ...
    data.ekip.forEach(kisi => {
      ...
      ekipEl.insertAdjacentHTML('beforeend', `<div class="team-card"><div class="team-avatar-wrap">${avatar}</div><div class="team-card-body"><h3>${kisi.isim}</h3><span class="team-role">${kisi.unvan}</span></div></div>`);
    });
  }
